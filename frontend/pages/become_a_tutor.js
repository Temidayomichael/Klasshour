					...
					<Carousel
						...
						<Box p='9' w='100%' h='450px'>
							<Flex>
								...
								<Text p='9' textAlign='left' fontSize='xs'>
									PRESHAYLA, PHYSICS TUTOR, LOUGHBOROUGH
								</Text>
							</Flex>
							<Text p='5' mt='14' fontSize='sm'>
								The fact everything's online is perfect for me, as I travel
								between home and uni a lot so could never commit to a regular
								job - not to mention the skills I’ve developed that I can put on
								my CV. More than anything though, it’s so rewarding - it makes
								me so proud to know I am making an actual difference.
							</Text>
						</Box>
						<Box p='9' w='100%' h='450px'>
							<Flex>
								<Box boxSize='32' m='2' border='1px solid black'></Box>
								<Text p='5' textAlign='left' fontSize='xs'>
									VICKI, ENGLISH TUTOR, YORK
								</Text>
							</Flex>
							<Text p='5' mt='14' fontSize='sm'>
								MyTutor has given me an opportunity to tutor a number of
								different subjects, both privately and through the Schools
								programme. For me, it is a great part time job as it's flexible
								and ideal alongside studying at uni.
							</Text>
						</Box>
						...
						<Box p='9' w='100%' h='450px'>
							...
							<Text p='5' mt='14' fontSize='sm'>
								...
								is the quality of the online classroom.
							</Text>
						</Box>
						<Box p='9' w='100%' h='450px'>
							<Flex>
								<Box boxSize='32' m='2' border='1px solid black'></Box>
								<Text p='5' textAlign='left' fontSize='xs'>
									KATIE, FRENCH TUTOR, BATH
								</Text>
							</Flex>
							<Text p='5' mt='14' fontSize='sm'>
								MyTutor has given me and new lease of life, allowing me to do
								the job that I love.
							</Text>
						</Box>
					</Carousel>
