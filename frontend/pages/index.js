import { Box, value, Button, Center, IconButton, Divider, Flex, Heading, Icon, Image, Input, InputGroup, SimpleGrid, Stack, Text, Drawer, DrawerOverlay, DrawerContent, DrawerHeader, DrawerBody, DrawerCloseButton, FormLabel, InputLeftAddon, Select, Textarea, DrawerFooter, InputRightAddon, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, ButtonGroup } from '@chakra-ui/react'
...
import { CheckIcon, ChevronLeftIcon, CloseIcon, EditIcon } from '@chakra-ui/icons';
import { initial } from 'lodash';
import { Editable, EditableInput, EditablePreview, useEditableControls, EditableControls,  } from "@chakra-ui/react"
                        ...
                        <InputGroup mt="24px" display={{ xl: "flex" }} >
                            ...
                            <Flex justifyContent='center' alignItems='center'>
                                <Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose} >
                                    <ModalOverlay />
                                    <ModalContent>
                                        <ModalHeader d='flex' justifyContent='space-between' w='44' alignItems='center'>
                                            <IconButton
                                                onClick={() => setBlock('none')} d={block} icon={<ChevronLeftIcon />}
                                            />
                                        </ModalHeader>
                                        <Flex pl='5' fontWeight='bold' fontSize='3xl'>Klasshour</Flex>
                                        <ModalCloseButton onClick={() => setBlock('none')} />
                                        <ModalBody>
                                            <Box>
                                                <Editable d='flex' defaultValue={subject} isPreviewFocusable={false}>
                                                    <EditablePreview />
                                                    <EditableInput />
                                                    <EditableControls />
                                                </Editable>
                                                ...
                                                <ModalFooter >

                                                    {
                                                        ...
                                                        block == 'none' ?
                                                            <>
                                                                <Box d='inline' >
                                                                    <Button mt='6' w='full' colorScheme="twitter" variant="solid" bg="#161B45" _hover={{ opacity: "0.9" }}
                                                                        _active={{
                                                                            bg: "#161B45",
                                                                            transform: "scale(0.88)",
                                                            ...
                                                            :
                                                            <Button mt='3' w='full' colorScheme="twitter" variant="solid" bg="#161B45" _hover={{ opacity: "0.9" }}
                                                                _active={{
                                                                    bg: "#161B45",
                                                                    transform: "scale(0.88)",
                                                                }}>Submit</Button>
