                        ...
                        <Stack w="30vw" spacing={7}>
                            ...
                            <Stack spacing={5}>
                                ...
                                <FormControl isInvalid={formik.errors.name && formik.touched.name}>
                                    <InputGroup>
                                        <InputLeftElement color="gray.400" children={<FaUserAlt />} />
                                        <Input id="name" placeholder="Fullname" type="text" onChange={formik.handleChange}
                                ...
                                <FormControl isInvalid={formik.errors.confirm_password && formik.touched.confirm_password}>
                                    <InputGroup>
                                        <InputLeftElement color="gray.400" children={<RiLockPasswordFill />} />
                                        <Input id="confirm_password" placeholder="Confirm password" type="password" onChange={formik.handleChange}
                                ...
                                <Stack isInline spacing="2" m="auto">
                                    ...
                                    <Box color="blue.400" mb="5" >
                                        <Link mb="10" href="/login">Login</Link>
                                    </Box>
